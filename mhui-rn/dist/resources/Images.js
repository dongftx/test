...
export default {
  ...
  navigation: {
    ...
    dark: {
       ...
       */
      record: {
        normal: require("./images/navigation/dark/record_n_dark.png"),
        press: require("./images/navigation/dark/record_p_dark.png"),
        disable: require("./images/navigation/dark/record_d_dark.png")
      },
       ...
       */
      orientation: {
        normal: require("./images/navigation/dark/orientation_n_dark.png"),
        press: require("./images/navigation/dark/orientation_p_dark.png"),
        disable: require("./images/navigation/dark/orientation_d_dark.png")
      }
    },
    ...
    light: {
       ...
       */
      record: {
        normal: require("./images/navigation/light/record_n_light.png"),
        press: require("./images/navigation/light/record_p_light.png"),
        disable: require("./images/navigation/light/record_d_light.png")
      },
       ...
       */
      orientation: {
        normal: require("./images/navigation/light/orientation_n_light.png"),
        press: require("./images/navigation/light/orientation_p_light.png"),
        disable: require("./images/navigation/light/orientation_d_light.png")
      }
    }
  },
  ...
  */
  loading: {
    dark: {
      empty: require("./images/loading/dark/loading_empty_dark.png")
    },
    light: {
      empty: require("./images/loading/light/loading_empty_light.png")
    }
  },
  sort: {
    light: {
      normal: require("./images/loading/light/sort_n_light.png"),
      press: require("./images/loading/light/sort_p_light.png")
    },
    dark: {
      normal: require("./images/loading/dark/sort_n_dark.png"),
      press: require("./images/loading/dark/sort_p_dark.png")
    }
  }
};