...
class ShareDialog extends React.Component {
  ...
  render() {
    ...
    return <AbstractDialog animationType={this.props.animationType} visible={this.props.visible} title={this.props.title} dialogStyle={this.props.dialogStyle} buttons={this.props.buttons} onDismiss={() => this._onDismiss()} useNewTheme>
