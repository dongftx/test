...
class MessageDialog extends React.Component {
      ...
      case TYPE.SUBTEXT:
        ...
        return <View style={{
          ...
          accessibilityHint: this.props.accessibilityHint
            ...
            <Text numberOfLines={extraTextNumberOfLines} allowFontScaling={this.props.dialogStyle.allowFontScaling} style={[styles.subText, this.props.dialogStyle.extraTextStyle]}>
              {this.props.extraText || ''}
            </Text>
          </View>;
  ...
  render() {
    ...
    return <AbstractDialog animationType={this.props.animationType} visible={this.props.visible} title={this.props.title} showTitle={showTitle} buttons={this.buttons} dialogStyle={this.props.dialogStyle} onDismiss={() => this._onDismiss()} useNewTheme {...getAccessibilityConfig({
      accessible: this.props.accessible
    })}>
