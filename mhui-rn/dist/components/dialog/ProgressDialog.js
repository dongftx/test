...
class ProgressDialog extends React.Component {
  ...
  render() {
    ...
    return <AbstractDialog animationType={this.props.animationType} visible={this.state.visible} showTitle={false} canDismiss={false} showButton={false} useNewTheme {...getAccessibilityConfig({
      accessible: false
    })}>
        ...
        }} progress={this.props.progress} color={this.props.color} unfilledColor={this.props.unfilledColor} width={Styles.dialog.modal.width - padding * 2} height={6} borderRadius={5.5} borderWidth={0} borderColor="#e5e5e5" useNativeDriver />
        </View>
      </AbstractDialog>;
  }
