...
class MHDatePicker extends React.Component {
  ...
  renderContent() {
    ...
    const actualWidth = this.modalWidth; // - (length - 1) * StyleSheet.hairlineWidth; // 去掉分割线的真实宽度 -- 10045去掉分割线
