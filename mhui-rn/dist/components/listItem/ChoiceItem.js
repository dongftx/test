...
export default class ChoiceItem extends React.Component {
  ...
  renderText() {
    ...
    return <View style={styles.textContainer}>
      ...
      }, color, textAlign, adaptedFontStyle, this.props.titleStyle]} numberOfLines={this.props.titleNumberOfLines} allowFontScaling={this.props.allowFontScaling}>
          {this.props.title}
        </Text>
        {this.props.subtitle ? <Text style={[styles.subtitle, {
        color: theme.colorGrayNormal
      }, color, textAlign, adaptedFontStyle, this.props.subtitleStyle]} numberOfLines={this.props.subtitleNumberOfLines} allowFontScaling={this.props.allowFontScaling}>
                {this.props.subtitle}
              </Text> : null}
      </View>;
  }
  ...
  render() {
    ...
    return <TouchableHighlight underlayColor={'#ECECEC'} onPress={() => this._onPress()} {...getAccessibilityConfig({
