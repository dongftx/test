...
class SlideGear extends React.Component {
  ...
  renderDraggable() {
    ...
    const whiteNoDark = new DynamicColor('#FFFFFF', 'rgba(255,255,255,0.9)');
    const greyNoDark = new DynamicColor('rgba(255,255,255,0.3)', 'rgba(255,255,255,0.3)');
  ...
  render() {
    ...
    return <View onLayout={() => this._onLayout()} ref={container => this._container = container} style={[this.props.containerStyle, containerStyle // { opacity }
